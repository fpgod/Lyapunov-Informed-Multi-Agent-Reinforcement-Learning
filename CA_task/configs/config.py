...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mappo', choices=["happo", "hatrpo", "mappo"])
    parser.add_argument("--experiment_name", type=str, 
                        default="robots", help="an identifier to distinguish different experiment.")
    ...
    parser.add_argument("--n_rollout_threads", type=int, 
                        default=1, help="Number of parallel envs for training rollouts")
    ...
    parser.add_argument("--num_env_steps", type=int, 
                        default=1e6, help='Number of environment steps to train (default: 10e6)')
    parser.add_argument("--user_name", type=str, 
                        default='buaa_yuxin',help="[for wandb usage], to specify user's name for simply collecting training data.")
    # env parameters
    ...
    parser.add_argument("--hidden_size", type=int, 
                        default=256, help="Dimension of hidden layers for actor/critic networks")
    parser.add_argument("--layer_N", type=int, 
                        default=1, help="Number of layers for actor/critic networks")
    parser.add_argument("--use_ReLU", action='store_false',
                        default=True, help="WhFether to use ReLU")
    ...
    parser.add_argument("--lr", type=float, 
                        default=7e-5, help='learning rate (default: 5e-4)')
    parser.add_argument("--critic_lr", type=float, 
                        default=7e-5, help='critic learning rate (default: 5e-4)')
