...
class advinf_Policy:
    """
    advinf Policy  class. Wraps actor and critic networks to compute actions and value function predictions.
    ...
    def get_actions_prob(self, obs, rnn_states_actor, masks, available_actions, deterministic):
        # (10, 80, 377), (10, 80, 11), (80, 1, 64), (80, 10, 1), (10, 80, 11, 17)
        # print(share_obs_batch.shape, actions_all_batch.shape, rnn_states_maa_batch.shape, masks_maa_batch.shape, available_actions_all_next_batch.shape)
    ...
    def get_maa_mean(self, share_obs_batch, actions_all_batch, rnn_states_maa_batch, masks_maa_batch, available_actions_all_next_batch):
        # (10, 80, 377), (10, 80, 11), (80, 1, 64), (80, 10, 1), (10, 80, 11, 17)
        # print(share_obs_batch.shape, actions_all_batch.shape, rnn_states_maa_batch.shape, masks_maa_batch.shape, available_actions_all_next_batch.shape)
        action_prob = self.maa.get_mean(share_obs_batch, actions_all_batch, rnn_states_maa_batch, masks_maa_batch, available_actions_all_next_batch)
        return action_prob
